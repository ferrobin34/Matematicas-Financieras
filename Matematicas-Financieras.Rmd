...
$\textbf{Definición 1}$ Definamos la función de acumulación $a(t)$ como el valor acumulado de un fondo al tiempo $t$ con inversión inicial de 1 (una unidad) al tiempo 0. 
